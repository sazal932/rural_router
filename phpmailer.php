...
function sendmail($tomail, $totmailname , $subject, $message)
{
	...
	$smtpport 	= 587;
	$mailsender = "The_Rural_Router";
	$companyname= "The_Rural_Router";
	$facebook = "https://www.facebook.com/The_Rural_Router";
	$twitter = "https://www.twitter.com/The_Rural_Router";
	$youtube = "https://www.youtube.com/The_Rural_Router";
	$linkedin = "https://www.linkedin.com/The_Rural_Router";
	$companyaddress  = "The_Rural_Router";
	$contactno = "7894561230";
	$url = "www.The_Rural_Router.com";
