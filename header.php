...
<head>
  ...
  <meta content="Agriculture Management System, The_Rural_Router" name="keywords">
    ...
    <div class="container">
      <div class="header-container d-flex align-items-center">
        <div class="logo mr-auto">
          <h1 class="text-light"><a href="index.php"><span>Rural Router</span></a></h1>
          ...
          <ul>
            ...
            <li><a href="displayworkers.php">Hire</a></li>
			      <li class="drop-down <?php
                            ...
                            ?>"><a href="displaysales.php" onclick='window.location=`displaysales.php`'>Market</a>
          <ul><?php
...
<li class="drop-down <?php
                            ...
                            ?>" ><a href="">My Account</a>
  <ul>
	<li><a href="workerpanel.php">My Profile</a></li>
	<li><a href="workerprofile.php">Update Profile</a></li>
...
<li class="drop-down <?php
  ...
  <ul>
	...
	<li class="drop-down"><a href="#">Market settings</a>
	  <ul>
